...
namespace TwoSum
{
    ...
    {
        private readonly TwoSumKata _kata = new TwoSumKata();

        [TestMethod]
        public void Array_2_7_5_11_Target_9_return_Array_0_1()
        {
            var actual = _kata.TwoSum(new int[] { 2, 7, 5, 11 }, 9);
        ...
        [TestMethod]
        public void Array_3_2_4_Target_6_return_Array_1_1()
        {
            var actual = _kata.TwoSum(new int[] { 3, 2, 4 }, 6);
        ...
        [TestMethod]
        public void Array_3_3_Target_6_return_Array_0_1()
        {
            var actual = _kata.TwoSum(new int[] { 3, 3 }, 6);
